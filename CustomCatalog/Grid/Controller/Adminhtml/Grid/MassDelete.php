...
use CustomCatalog\Grid\Model\ResourceModel\Grid\CollectionFactory;
...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('CustomCatalog_Grid::row_data_delete');
    }
}
